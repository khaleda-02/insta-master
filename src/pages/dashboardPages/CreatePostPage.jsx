...
const createPostPage = () => {
  ...
  const generateHandler = async (event) => {
    ...
    dispatch(
      createPost({
        ...
        timeToShare: dateRef.current.value,
      }),
    )
      .unwrap()
      .then((data) => {
        ...
        const post = {
          ...
          caption:
            data.caption ||
            "there is no caption for this title , please try aonther title ...",
          ...data,
        };
  ...
  const saveChangesHandler = () => {
    dispatch(
      updatePost({ caption: createdPost.caption, postId: createdPost._id }),
    )
      .unwrap()
      .then((post) => {
      ...
      <div className="w-[100%] lg:w-[50%] ">
        ...
        <form className="flex flex-col 2xl:flex-row items-start 2xl:items-end justify-start gap-4 ">
          <div className="">
            <label
              htmlFor="keywords"
              className="block text-3xl font-bold text-white mb-4"
            >
              Keywords{" "}
            </label>
            <input
              ...
              type="text"
              id="keywords"
              className=" border-gray-300 text-xl w-[300px] block px-5 py-2.5  text-white"
          ...
          <button
            ...
            type="submit"
            className="text-white px-5 py-2.5 text-center text-xl bg-purple w-fit h-fit sono"
          >
            Generate
          </button>
        </form>
        {/* From  info */}
        <p className="capitalize">please enter a valid date ( at least now )</p>
